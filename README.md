# 🤖 あいことば｜AIプレゼンフィードバックアプリ

🎥 [▶ デモ動画を見る（YouTube）](https://youtu.be/xoO1wj5GWFI)

## 概要（What’s this?）
あいことばは、小学4年生（10歳）くらいの子どもたちを主な対象とした「自分の考えを自信を持って話す力」を育てるアプリです。
子どもがプレゼンを録音すると、AIが自動で文字起こし＆分析し、得点やフィードバックを生成。スコアでゲーム感覚で楽しめるため、子どもでも継続しやすい設計にしています。


## 目的・背景（Why this app?）  
日本の子供は「皆の前で発表するのが苦手」「自分の意見を伝える自信がない」傾向が強いと言われています。しかし、学校や家庭では体系的なプレゼン教育や語彙力のトレーニング機会が限られています。「あいことば」は、家庭でも放課後でも、時間や場所に縛られず、プレゼンの練習ができます。授業や発表の場で、自分の言葉で意見が伝えられるようになることを目指し、いつでもどこでも楽しく練習できる環境を提供します。
...
※このアプリは現在、開発環境で動作するローカルアプリです（未デプロイ）。  
GitHubにてコードをクローンし、ローカルで動作させてご確認ください。
...
---
<details>
<summary>📂 .envファイルの設定をすべて表示する（クリックで開閉）</summary>
...
## クレジット
本アプリ「あいことば」は、Ms.Engineer BC2504期チームBの最終プロジェクトとして３週間で開発しました。  
こどもたちが「自分の言葉で話す力」を楽しく育てられるよう、設計からUI体験まで工夫しています。
